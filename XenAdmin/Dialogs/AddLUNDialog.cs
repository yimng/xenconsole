...
{
    public partial class AddLUNDialog : DialogWithProgress
    {
        ...
        public AddLUNDialog(SR sr, List<FibreChannelDevice> list)
        {            
            InitializeComponent();
            this.sr = sr;
            FCDevices = list;
        ...
        private void replace_Click(object sender, EventArgs e)
        {
            ...
            _repairAction = new SrAddLUNAction(sr.Connection, sr, _selectedDevices[0].SCSIid);
